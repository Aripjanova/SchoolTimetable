            ...
            <div>
                        ...
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                ...
                                <Form>
                                    ...
                                    <input value={this.state.name} onChange={ e=>this.setState({name:e.target.value})} placeholder={"класстын аталышы"}></input>

                                    <input value={this.state.id_class}  onChange={ e=>this.setState({id_class:e.target.value})} placeholder={"классы"}></input>
                            ...
                            <div className="modal-footer">
                                ...
                                <button type="button" className="btn btn-primary" onClick={this.addClass}>Классты кошуу</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="modal fade" id="editClass" tabIndex="-1" role="dialog"
                    ...
                    <div className="modal-dialog" role="document">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h5 className="modal-title" id="exampleModalLabel">Классты өзгөртүү</h5>
                                <button type="button" className="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div className="modal-body">
                                ...
                                <Form>
                                    ...
                                    <input style={{display:"inline"}} value={this.state.editName} onChange={ e=>this.setState({editName:e.target.value})} placeholder={this.state.editName}></input>
                                    <Form.Text className="text-muted" >
                                        класстын аталышы
                                    </Form.Text>
                                    <input value={this.state.edit_id_class}  onChange={ e=>this.setState({edit_id_class:e.target.value})} placeholder={this.state.edit_id_class}></input>
                                    <Form.Text className="text-muted" >
                                        классы
                                    </Form.Text>
                            ...
                            <div className="modal-footer">
                                ...
                                <button type="button" className="btn btn-primary" onClick={this.editClass}>Өзгөртүү</button>
                            </div>
                        </div>
                    </div>
                </div>
